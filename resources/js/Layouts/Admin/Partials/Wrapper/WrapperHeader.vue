      ...
      <div class="header-container container-xxl">
         <div
            ...
            <h1 class="d-flex flex-column text-gray-900 fw-bold my-1">
               <span class="fs-1">Categories</span>
            </h1>
         </div>
         <div class="d-flex align-items-center flex-shrink-0">
            <div class="me-3 py-3 py-lg-0">
               <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-225px"
                  ...
                  <div data-kt-search-element="toggle" class="search-toggle-mobile d-flex d-lg-none align-items-center">
                     <div
                        class="d-flex btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline bg-transparent w-40px h-40px">
            ...
            <div class="d-flex align-items-center py-3 py-lg-0">
               <div class="me-3">
                  <div
                     class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline bg-transparent w-40px h-40px position-relative"
                  ...
                  <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px position-absolute"
                     data-kt-menu="true" id="kt_menu_notifications" style="margin-left:-320px;">
               ...
               <div class="me-3">
                  ...
                  <div
                     class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px position-absolute"
               ...
               <div class="me-3">
                  ...
                  <!-- custom-style-theme -->
                  <div
                     class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px position-absolute"
                     data-kt-menu="true" data-kt-element="theme-mode-menu" style="margin-left:-110px;">
